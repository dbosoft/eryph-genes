...
This geneset contains the base catlet for Windows 10 2004 Enterprise.
...
``` ps
New-Catlet -Parent "dbosoft/win10-2004-enterprise"
```
...
``` ps
New-Catlet -Parent "dbosoft/win10-2004-enterprise/starter"
```
